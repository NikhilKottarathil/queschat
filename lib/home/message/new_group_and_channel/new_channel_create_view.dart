...
class NewChannelCreateView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return BlocListener<NewGroupCubit, NewGroupState>(
      ...
      child: Scaffold(
        appBar:
            appBarWithBackButton(titleString: 'New Channel', context: context),
        body: Column(
          children: [
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Description',
                      style:
                          TextStyle(color: AppColors.TextFourth, fontSize: 18),
                    ),
                    Expanded(
                      child: Container(
