                ...
                child: MultiBlocProvider(
                  providers: [
                    ...
                    BlocProvider<FeedsBloc>(
                      create: (BuildContext context) => FeedsBloc(feedRepository: feedRepository),
                    ),
                    BlocProvider<PostMcqBloc>(
                      create: (BuildContext context) => PostMcqBloc(feedRepo: feedRepository),
                    ), BlocProvider<PostBlogBloc>(
                      create: (BuildContext context) => PostBlogBloc(feedRepo: feedRepository),
                    ),
